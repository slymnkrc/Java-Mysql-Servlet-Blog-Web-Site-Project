...
public class Util {
    public final static String base_url = "http://localhost:8080/BlogSite_war_exploded/";
    ...
    public static String MD5(String md5){
        try {
            ...
            System.err.println("Util MD5 error : " + e);
        }
        return null;
    }
            ...
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("user")) {
                    ...
                    try {
                        ...
                        request.getSession().setAttribute("username", arr[1] + " " + arr[2]);
