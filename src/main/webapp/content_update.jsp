    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form action="content-update" method="post" >
                <div class="mb-3">
                    <input value="<%=content.getCategory()%>" type="text" name="category" placeholder="Kategori" class="form-control" required />
                </div>
                <div class="mb-3">
                    <input value="<%=content.getTitle()%>" type="text" name="title" placeholder="Başlık" class="form-control" required />
                </div>

                <div class="mb-3">
                    <textarea type="text" name="detail" maxlength="5000" placeholder="Detay" class="form-control" required><%=content.getDetail()%> </textarea>
